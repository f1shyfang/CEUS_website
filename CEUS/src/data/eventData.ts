...
const eventImage = (fileName: string): string => getPublicStorageUrl('events', fileName);

const baseEventsData: Event[] = [
  // --- UPCOMING EVENTS (From Term 2, Week 8 onwards) ---
  {
    ...
    imageUrl: STORAGE_IMAGE_URLS.defaultEvent,
    ...
    imageUrl: eventImage('CEUS at Roundy (Facebook Cover).png'),
  ...
  },
  {
    ...
    imageUrl: eventImage('STUDY WITH CEUS T2 2025.png'),
    facebookEventLink: '#', // Add Facebook event link
  ...
  
  {
    ...
    imageUrl: eventImage('CEUS X SUCES PUBCRAWL T2 2025 (Facebook Cover).png'),
    facebookEventLink: '#', // Add Facebook event link
  ...
  },
  {
    ...
    imageUrl: eventImage('T325 OPAL SITE TOUR (1920 x 1080 px).png'),
  ...
  },
  {
    ...
    imageUrl: eventImage('AGM 2025.png'),
  ...
  },
  {
    ...
    imageUrl: eventImage('T325 Speed Networking Night (1920 x 1080 px).png'),
  ...
  },
  {
    ...
    imageUrl: eventImage('beach-day-coogee-nov-2025.png'),
  ...
  },
  {
    ...
    imageUrl: eventImage('PUBCRAWL (1920 x 1080 px).png'),
...
export const allEventsData: Event[] = baseEventsData;